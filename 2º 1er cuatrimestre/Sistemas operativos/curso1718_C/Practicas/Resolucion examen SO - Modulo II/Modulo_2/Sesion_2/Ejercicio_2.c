...
int main(int argc, char **argv){
	...
	//Si no lo es, se para la ejecución y se muestra como ejecutar
	else
	{
	...
	{
        //Imprimimos en la variable "cadena" la dirección del archivo actual
		...
		if(S_ISREG(atributos.st_mode))
		{
            ...
            //Imprimimos el nombre y los atributos de protección del archivo
			printf("%s: %o ", cadena2, atributos.st_mode);
            
            //Cambiamos los permisos del directorio contenido en "cadena"
            //(que es en realidad la dirección absoluta de "cadena2")
